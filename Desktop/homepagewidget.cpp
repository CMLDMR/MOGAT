...
HomePageWidget::HomePageWidget()
{
...

    {
        ...
        mLayout->addWidget(cpp14::make_unique<WText>("<strong>The outcomes of this project will help the target groups to overcome the constraints of current situation in L2 courses thanks to</strong>"
                                            ...
                                            "<p>- an industry oriented approach: the project is supported by major HRD departments of European business stakeholders - they will participate in the L2 tournaments and become direct beneficiaries of the project;</p>"
        ...
        mLayout->addWidget(cpp14::make_unique<WText>("<p><b>IMPACT desired</b></p>"
